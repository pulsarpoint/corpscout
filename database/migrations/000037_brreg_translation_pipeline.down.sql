...
DROP INDEX IF EXISTS idx_brreg_raw_translation_lease;
DROP INDEX IF EXISTS idx_brreg_raw_translation_status;

ALTER TABLE brreg_company_raw_inputs
  DROP CONSTRAINT IF EXISTS chk_brreg_translation_attempts,
  DROP CONSTRAINT IF EXISTS chk_brreg_raw_payload_en_object,
  DROP CONSTRAINT IF EXISTS chk_brreg_translation_status,
  DROP COLUMN IF EXISTS translation_fx_rate_date,
  DROP COLUMN IF EXISTS translation_fx_source,
  DROP COLUMN IF EXISTS translation_lease_until,
  DROP COLUMN IF EXISTS translation_lease_by,
  DROP COLUMN IF EXISTS translated_at,
  DROP COLUMN IF EXISTS translation_prompt_version,
  ...
  DROP COLUMN IF EXISTS raw_payload_en;
