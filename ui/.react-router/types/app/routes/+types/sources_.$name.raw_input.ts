...
type Module = typeof import("../sources_.$name.raw_input.js")

type Info = GetInfo<{
  file: "routes/sources_.$name.raw_input.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../sources_.$name.js");
}, {
  id: "routes/sources_.$name.raw_input";
  module: typeof import("../sources_.$name.raw_input.js");
}];
